...
/**
 * 设立一个差分数组，计算数组中每个数每次移位对记分的贡献，最终取最高分的下标
 *
 * 思路：https://github.com/wisdompeak/LeetCode/tree/master/Others/798.Smallest-Rotation-with-Highest-Score
 */
class Solution
{
public:
